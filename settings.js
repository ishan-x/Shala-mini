...
module.exports = {
    ...
    MONGO_URI: process.env.MONGO_URI || 'mongodb+srv://ishanxbot_db_user:Pd5vk1hxeckj3Id7@kavya.hkszxa3.mongodb.net/?appName=kavya',
    MONGO_DB: process.env.MONGO_DB || 'kavyaxbot',
